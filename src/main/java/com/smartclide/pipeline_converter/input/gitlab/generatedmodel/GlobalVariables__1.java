...
public class GlobalVariables__1 {
    ...
    public String toString() {
        ...
        sb.append(GlobalVariables__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GlobalVariables__1) == false) {
            return false;
        }
        GlobalVariables__1 rhs = ((GlobalVariables__1) other);
