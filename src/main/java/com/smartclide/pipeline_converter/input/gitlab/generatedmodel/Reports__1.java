...
public class Reports__1 {
    ...
    public String toString() {
        ...
        sb.append(Reports__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("junit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Reports__1) == false) {
            return false;
        }
        Reports__1 rhs = ((Reports__1) other);
