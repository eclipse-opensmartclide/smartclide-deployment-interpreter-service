...
public class SecretsPropertyProperty {
    ...
    public String toString() {
        ...
        sb.append(SecretsPropertyProperty.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("vault");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SecretsPropertyProperty) == false) {
            return false;
        }
        SecretsPropertyProperty rhs = ((SecretsPropertyProperty) other);
